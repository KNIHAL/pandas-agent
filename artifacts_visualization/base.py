...
class ChartGenerator(ABC):
    ...
    def _save_chart(self, config, title="Chart"):
        # Get absolute path to the repo root (two levels up from this file)
        ...
        template_path = os.path.join(base_dir, 'artifacts_visualization', 'templates', f'{self.chart_type}_template.html')
