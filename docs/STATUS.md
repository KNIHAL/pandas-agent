...
- connectors — ✅ done (branch feature/connectors, off main; base Connector interface + CSV/Postgres connectors + DatasetRegistry + 8 data-quality checks + 12 tools registered with tool-gateway, 47/47 tests passing)
