...
- artifacts-visualization — 🔧 in-progress (branch feature/artifacts-visualization not yet created; `core/chart_generators/*` moved/adapted to `artifacts_visualization/`; `generate_chart` tool wired into tool-gateway, 5/5 module tests passing, 416/416 full-repo baseline passing; next: CSV/Excel/PDF/report export tools)
- desktop-app — ⬜ pending
