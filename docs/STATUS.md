...
- artifacts-visualization — ✅ done, merged to main (all 5 tasks complete: chart_generators moved to artifacts_visualization/, generate_chart/export_dataset/generate_report/finalize_artifact/list_artifacts/regenerate_artifact wired into tool-gateway with SQLite-backed persistence; 15/15 module tests, 426/426 full-repo suite)
- desktop-app — ⬜ pending
