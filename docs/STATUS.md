...
Current active module: investigation-engine
...
- investigation-engine — 🔧 in-progress (branch feature/investigation-engine, off main; Investigation State schema + persistence (in-memory + Redis) built, 10/10 tests passing; next: analytical engine core ops)
