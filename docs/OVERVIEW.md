...
- Desktop App -- Tauri + Next.js UI, Python runtime bundled, cross-platform (Win/Mac/Linux) with auto-update
- Landing Page -- static site (no web app), where users download the desktop app / CLI / GitHub package
...
## Full spec
See `raw.txt` in this folder for the complete detailed spec -- avoid re-reading it;
everything needed is already distilled into each module's spec.md.
